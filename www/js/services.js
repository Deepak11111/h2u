...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://h2c-kart.firebaseio.com/"),
    refCart = new Firebase("https://h2c-kart.firebaseio.com/cart"),
    refUser = new Firebase("https://h2c-kart.firebaseio.com/users"),
    refCategory = new Firebase("https://h2c-kart.firebaseio.com/category"),
    refOrder = new Firebase("https://h2c-kart.firebaseio.com/orders"),
    refFeatured = new Firebase("https://h2c-kart.firebaseio.com/featured"),
    refMenu = new Firebase("https://h2c-kart.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
